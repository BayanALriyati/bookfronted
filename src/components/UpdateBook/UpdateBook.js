...
export default function UpdateBook() {
  ...
  useEffect(()=>{
    axios.get(`http://localhost/bookfronted/backend/books/get.php?id=${param.id}`).then(res =>{
      console.log(res)
      setBook(res.data)
    })
  },[])
...
const handleSubmit=(e)=>{
  ...
  axios.post('http://localhost/bookfronted/backend/books/update.php',formData)
  .then(res=> {
    console.log(res);
    // setBook({
    //   title:'',
          ...
          <form action=""  onSubmit={handleSubmit}>
            <div className="row gutters">
              ...
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <h3 className="mb-2  personal mb-5">Update Information  <hr/></h3>
              </div>
              {/*  */}
            ...
            <div className="row gutters">
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div className="text-right">
                  ...
                  <input type="submit" className="btn btn-outline-success ms-2 bton" value="Update Book"/>
                </div>
              </div>
            </div>
          </form>
